...
<body class="d-flex justify-content-center align-items-center mt-5 p-3">
    <form action="./login.php" method="post" class="w-50 p-5">
        ...
        <div class="input-group mt-3">
            ...
            <input type="email" id="email-id" class="form-control fs-4" placeholder="email" name="email">
        </div>
        <div class="input-group mt-3">
            <i class="bi bi-lock-fill input-group-text fs-2"></i>
            <input type="password" id="pass-id" class="form-control fs-4" placeholder="contraseña" name="pass">
        </div>
